...
#define ITEM_03D 61
#define ITEM_03E 62
#define ITEM_NULL_STONE 63	 // Formerly HP UP, Now suppresses ability
#define ITEM_HOURGLASS 64	 // Formerly Protein, Now extends trick room length by 2 turns
#define ITEM_BARRAGE_BELT 65 // Formerly Iron, Now increases defense by 1.5
#define ITEM_PESTICIDE 66	 // Formerly Carbos, Now increases the defenses of bug types
#define ITEM_ROULETTE 67	 // Formerly Calcium, Now increases a random stat by 2
#define ITEM_RARE_CANDY 68
#define ITEM_PP_UP 69
#define ITEM_ENERGIZER 70 // Formerly Zinc, Now gives focus energy status
#define ITEM_PP_MAX 71
#define ITEM_048 72
#define ITEM_EVIOLATE 73	   // Formerly GUARD_SPEC, Now eviolite for offensive stats
#define ITEM_BRIGHT_MIRROR 74  // Formerly Dire Hit, Now provides one time magic bounce use
#define ITEM_EARMUFFS 75	   // Formerly X_ATTACK, Now makes user immune to sound moves
#define ITEM_MEGAPHONE 76	   // Formerly X_DEFEND, Now increases power of sound moves by 1.2
#define ITEM_CRYSTALIZER 77	   // Formerly X_SPEED, Now Multiscale for one time usage
#define ITEM_ENHANCER 78	   // Formerly X_ACCURACY, Now Serene Grace as an item
#define ITEM_PUNCHING_GLOVE 79 // Formerly X_SPECIAL, Now Punching Glove
